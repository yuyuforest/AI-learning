...
public class Utils {
    ...
    public static final int TYPE_ELEPHANT = 2;
    public static final int TYPE_HORSE = 3;
    public static final int TYPE_CHARIOT = 4;
    public static final int TYPE_CANNON = 5;
    public static final int TYPE_SOLDIER = 6;
    public static final int COLOR_NONE = -1;
    public static final int COLOR_RED = 0;
    public static final int COLOR_BLACK = 1;
    public static final int[][] INITIAL_BLACK_BOARD = {
            {1, 1, TYPE_CHARIOT},
            {2, 1, TYPE_HORSE},
            {3, 1, TYPE_ELEPHANT},
            {4, 1, TYPE_ADVISOR},
    ...
    public static final int[][] INITIAL_RED_BOARD = {
            {1, 10, TYPE_CHARIOT},
            {2, 10, TYPE_HORSE},
            {3, 10, TYPE_ELEPHANT},
            {4, 10, TYPE_ADVISOR},
    ...
    public static final int WINNER_RED = 0;
